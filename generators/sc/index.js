...
module.exports = class extends Generator {
    ...
    prompting() {
        let prompt = [{
            ...
            choices: [this.langJSON.sc.templateConfig.custom, this.langJSON.sc.templateConfig.default],
            default: this.langJSON.sc.templateConfig.custom
        }];
        let promptInput = [{
            type: 'input',
            name: 'customRemote',
        ...
        return this.prompt(prompt)
            ...
            .then((props) => {
                if (this.remoteType === this.langJSON.sc.templateConfig.default) {
                    return;
                }
